...
<h5 class="font-white space-xs">Find restaurants, specials, and coupons for free</h5>
                    ...
                    <div class="steps">
                        <div class="step-item step1">
                            ...
                            <h4><span>1. </span>Choose Menu</h4> </div>
                        <!-- end:Step -->
...
<?php 
						...
						$query_res = mysqli_query($db,"select * from menu m join food_preference fp on m.fk_food_preference_id=fp.pk_food_preference_id LIMIT 3"); 
									      while($r=mysqli_fetch_array($query_res))
										  {
													if(isset($_SESSION['login'])){
                                                        echo '  <div class="col-xs-12 col-sm-6 col-md-4 food-item">
														<div class="food-item-wrap">
															<div class="figure-wrap bg-image" data-image-src="./assets/images/dish.png">
																<img src="./assets/images/dish.png" class="img-fluid">
															</div>
															<div class="content">
																<h5><a href="ordernow.php?id='.$r['pk_menu_id'].'">'.$r['menu_name'].'</a></h5>
																<div class="product-name">'.$r['food_preference_name'].'</div>
																<div class="price-btn-block"> <span class="price">$'.$r['price'].'</span> 
                                                                <a href="ordernow.php?id='.$r['menu_name'].'" class="btn theme-btn-dash pull-right">Order Now</a> 
                                                                </div>
															</div>
